...
const menuElemani1 = MenuElemaniOlustur("Cheeseburger", 10, "Burgerler");
const menuElemani2 = MenuElemaniOlustur("Margarita Pizza", 12, "Pizzalar");
const menuElemani3 = MenuElemaniOlustur("Tavuk Şiş", 15, "Izgaralar");

console.log(menuElemani1);
console.log(menuElemani2);
console.log(menuElemani3);
...
degerlendirmeler.find((item) => item.isim === "Reyna").geribildirim =
